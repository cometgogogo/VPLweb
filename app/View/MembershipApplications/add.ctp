...
<?php
$this->html->addCrumb("Home" , "http://www.vaughanpl.info/index.php");
$this->html->addCrumb("Using the Library" , "http://www.vaughanpl.info/services");
$this->html->addCrumb("Membership" , "http://www.vaughanpl.info/services/membership");
?>


<?php

//echo $this->request->data["MembershipApplication"]["age"];


?>

<!-- Mandatory fields depend on the age of the applicant -->
<?php $mandatoryFields = $this->controller->MembershipApplication->mandatoryFields(@$this->request->data["MembershipApplication"]["age"]) ?>
...
<script language="javascript" type="text/javascript">
	 ...
	 */
	function onLoad() {
		changeAge("<?php echo @$this->request->data["MembershipApplication"]["age"]; ?>");
	}
	...
	function changeAge(selected_option) {
		...
		if (selected_option == "adult") {
			...
			document.getElementById("step_data").style.display="block";
			document.getElementById("parent_data").style.display="block";
			document.getElementById("field_age_description_adult").style.display="block";
			document.getElementById("submit_button").style.display="block";
		}
	}
			...
			<div class="whole_width">
				...
				<div id="step_age" class="input_step">
					<fieldset><legend>Your Age</legend>
						...
						<!-- Age entry field -->
						<div id="field_age" class="field<?php if ($this->request->data["MembershipApplication"]["step"] != "age") echo ' hidden'; ?>">
						...
						<div id="field_age_info" class="field<?php if ($this->request->data["MembershipApplication"]["step"] != "data") echo ' hidden'; ?>">
							<div class="field_label">Age range:</div>
							<div class="field_input">
								<?php echo $ages[$this->request->data["MembershipApplication"]["age"]]; ?>
						...
						<div id="field_age_description_adult" class="field<?php if ($this->request->data["MembershipApplication"]["step"] != "data") echo ' hidden'; ?>">
							...
							<div class="field_input">
								...
								You will have thirty days to pick-up your card at your local branch selected below. If not picked up within thirty days your Library Card number will expire.<br/><br/>Verification of address is required.<br/><br/>If you are under the age of 13, please bring a parent or guardian with you to register at the library.Your parent or guardian will be asked for proof of their own name and current address, and will be asked to sign your card.<br/><br/>The personal information collected from you on this form will only be used for the purpose of registering you for Vaughan Public Libraries. Your personal information will not be shared with any outside organization.
							</div>
						</div>


						<!-- Instructions for teens -->
						<!-- div id="field_age_description_teen" class="field<?php if ($this->request->data["MembershipApplication"]["step"] != "data" || $this->request->data["MembershipApplication"]["age"]!="teen") echo ' hidden'; ?>">
							<div class="field_label">Details:</div>
							<div class="field_input">
						...
						<!-- div id="field_age_description_kid" class="field<?php if ($this->request->data["MembershipApplication"]["step"] != "data" || $this->request->data["MembershipApplication"]["age"]!="kid") echo ' hidden'; ?>">
							<div class="field_label">Details:</div>
							<div class="field_input">
				...
				<!-- Data entry -->
				<div id="step_data" class="input_step<?php if ($this->request->data["MembershipApplication"]["step"] == "age") echo ' hidden'; ?>">
					...
					<fieldset><legend>Personal Information</legend>
						...
						<!-- First name field -->
						<div class="field">
							<div class="field_label"><label for="MembershipApplicationFirstName"><span class="mandatory_indicator">*</span>First Name:</label></div>
							<div class="field_input">
						...
						<div id="field_last_name" class="field">
							<div class="field_label"><label for="MembershipApplicationLastName"><span class="mandatory_indicator">*</span>Last Name:</label></div>
							<div class="field_input">
						...
						<div class="field">
							...
							<div class="field_input">
								...
								<div id="field_eligibility_resident" class="field<?php if ($this->request->data["MembershipApplication"]["eligibility"] != "resident") echo ' hidden'; ?>">
								...
								<div id="field_eligibility_student" class="field<?php if ($this->request->data["MembershipApplication"]["eligibility"] != "student") echo ' hidden'; ?>">
								Please bring valid photo student ID or a letter from your school principal.<br/>
								</div>

								<div id="field_eligibility_property" class="field<?php if ($this->request->data["MembershipApplication"]["eligibility"] != "property") echo ' hidden'; ?>">
								...
								<div id="field_eligibility_work" class="field<?php if ($this->request->data["MembershipApplication"]["eligibility"] != "work") echo ' hidden'; ?>">
								...
								<?php echo $html->radio('MembershipApplication/cityemployee', array("yes"=>"Yes&nbsp;","no"=>"No"),null, array("onclick"=>"changeCityEmployee(this.value)")); ?>
									...
									<div id="field_city_employee" class="field<?php if ($this->request->data["MembershipApplication"]["cityemployee"] != "yes") echo ' hidden'; ?>">

									<label for="MembershipApplicationCityDept">Please enter your department and location:</label> <br/>
						...
						<div id="field_library" class="field">
							<div class="field_label"><label for="MembershipApplicationLibrary"><span class="mandatory_indicator">*</span>Local Library:</label></div>
							<div class="field_input">
								<?php echo $html->selectTag('MembershipApplication/library', $libraries,@$this->request->data["MembershipApplication"]["library"],null,null,false); ?>
								<br /><br />
							</div>
						...
						<!--<div id="field_age" class="field<?php if (@$this->request->data["MembershipApplication"]["age"] != 'adult') echo ' hidden'; ?>">-->
						<div class="field">
					...
					<fieldset><legend>Contact Information</legend>
						...
						<!-- Street field -->
						<div class="field">
							<div class="field_label"><label for="MembershipApplicationAddress"><span class="mandatory_indicator">*</span>Address:</label></div>
							<div class="field_input">
						...
						<div class="field">
							<div class="field_label"><label for="MembershipApplicationSuite">Suite/Apt:</label></div>
							<div class="field_input">
						...
						<!-- City field -->
						<div class="field">
							<div class="field_label"><label for="MembershipApplicationCity"><span class="mandatory_indicator">*</span>City:</label></div>
							<div class="field_input">
						...
						<!-- Province field -->
						<div class="field">
							<div class="field_label"><label for="MembershipApplicationProvince">Province:</label></div>
							<div class="field_input">
						...
						<!-- Postal code field -->
						<div class="field">
							<div class="field_label"><label for="MembershipApplicationPostalCode"><span class="mandatory_indicator">*</span>Postal Code:</label></div>
							<div class="field_input">
								<?php echo $html->input('MembershipApplication/postal_code', array("size"=>"7","maxlength"=>"7")); ?>
							</div>
							<?php echo $html->tagErrorMsg('MembershipApplication/postal_code','Please enter the Postal Code'); ?>
						</div>


						<!-- Telephone field -->
						<div id="field">
							<div class="field_label"><label for="MembershipApplicationTelephone"><span class="mandatory_indicator">*</span>Telephone:</label></div>
							<div class="field_input">
								<?php echo $html->input('MembershipApplication/telephone', array("size"=>"15","maxlength"=>"20")); ?>
							</div>
						<?php echo $html->tagErrorMsg('MembershipApplication/telephone','Please enter correct phone number.'); ?>
						</div>


						<!-- Email field -->
						<div class="field">
							<div class="field_label"><label for="MembershipApplicationEmail"><span class="mandatory_indicator">*</span>Email:</label></div>
							<div class="field_input">
						...
						<!-- PIN field -->
						<!--<div id="field_telephone" class="field<?php if (@$this->request->data["MembershipApplication"]["age"] != 'adult') echo ' hidden'; ?>">-->
						<div class="field">
							<div class="field_label"><label for="MembershipApplicationPin"><span class="mandatory_indicator">*</span>Please select a four (4) digit PIN:</label></div>
							<div class="field_input">
...
<div id="parent_data" class="input_step<?php if ($this->request->data["MembershipApplication"]["age"] == "adult" || $this->request->data["MembershipApplication"]["step"] == "age") echo ' hidden'; ?>">
<fieldset><legend>Parent/Guardian Information</legend>

	<!-- First name field -->
	<div class="field">
		<div class="field_label"><label for="MembershipApplicationParentFirstName"><span class="mandatory_indicator">*</span>First Name:</label></div>
		<div class="field_input">
			<?php echo $html->input('MembershipApplication/parent_first_name', array("size"=>"20","maxlength"=>"20")); ?>
		</div>
		<?php echo $html->tagErrorMsg('MembershipApplication/parent_first_name','Please enter parent/guardian first name'); ?>
	</div>


	<!-- Last name field -->
	<div class="field">
		<div class="field_label"><label for="MembershipApplicationParentLastName"><span class="mandatory_indicator">*</span>Last Name:</label></div>
		<div class="field_input">
			<?php echo $html->input('MembershipApplication/parent_last_name', array("size"=>"20","maxlength"=>"20")); ?>
		</div>
		<?php echo $html->tagErrorMsg('MembershipApplication/parent_last_name','Please enter parent/guardian last name'); ?>
	</div>
</fieldset>
</div>
				...
				<input type="hidden" name="data[MembershipApplication][step]" value="<?php echo $this->request->data["MembershipApplication"]["step"]; ?>" />
				<input id="step" type="hidden" name="step" value="<?php echo $this->request->data["MembershipApplication"]["step"]; ?>" />


				<!-- Submit button -->
				<?php echo $html->submit("Continue", array("id"=>"submit_button", "class"=>"submit_button" . ((@$this->request->data["MembershipApplication"]["age"] != "adult" && $this->request->data["MembershipApplication"]["step"]=="data") ? " hidden" : ""))); ?>
			</div>
