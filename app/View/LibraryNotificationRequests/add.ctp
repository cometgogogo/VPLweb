...
<script language="javascript">
	...
	function changePurpose(selected_option) {
		...
		document.getElementById("field_text").style.display="none";
		...
		if (selected_option == "begin") { //begin email
			...
			document.getElementById("footnote_texting_notices").style.display="none";
			document.getElementById("field_buzz").style.display="none";
			document.getElementById("field_text").style.display="block";
			document.getElementById("submit_form").style.display="none";
		...
		<?php echo $html->formTag('/library_notification_requests/add/' . $html->tagValue('EmailNotificationRequest/id')); ?>
			<div class="whole_width">
				...
				<div id="step_purpose" class="input_step">
					<fieldset><legend>Your Request</legend>
						...
						<div id="field_purpose_description_texting" class="field<?php if ($this->data["EmailNotificationRequest"]["step"] != "data" || $this->data["EmailNotificationRequest"]["purpose"]!="texting") echo ' hidden'; ?>">
							...
							<div class="field_input">
								<div class="important_note">
									...
									<br /><br/>Vaughan Public Libraries is not responsible for delivery failure due to the problems with the receiver's wireless account or service provider.<br/><br/>
						...
						<div id="field_purpose_description_begin" class="field<?php if ($this->data["EmailNotificationRequest"]["step"] != "data" || $this->data["EmailNotificationRequest"]["purpose"]!="begin") echo ' hidden'; ?>">
							...
							<div class="field_input">
								<div class="important_note">
								<?php echo $this->data["EmailNotificationRequest"]["purpose"]; ?>
				...
				<div id="step_data" class="input_step<?php if ($this->data["EmailNotificationRequest"]["step"] != "data") echo ' hidden'; ?>">
					...
					<div id= "field_text" class="hidden">
					<fieldset><legend>Get Texts From VPL</legend>
					<p>It's easy to get started...
					<ul><li>Text <strong>Signup</strong> to 647-694-1289</li><li>Follow the instructions</li></ul>
					</p>
					<p>You will start receiving four types of notices:
					<ul>
					<li>Courtesy - something is due soon</li>
					<li>Availablility - a hold is ready for pickup</li>
					<li>Reminder - you haven't picked up your hold yet</li>
					<li>Overdue - something is overdue</li></ul>
					</p>
					<p>You can even renew from Courtesy and Overdue notices! <br/><br/> And it's easy to add all your family's cards to one mobile number...
					<ul><li>Text <strong>Addcard</strong> to 647-694-1289</li><li>Follow the instructions</li><li>Repeat for each card you want to add</li></ul></p>
					<p>Check the <?php echo $html->link("Keywords Chart","/files/services/ShoutbombKeywordsChart.pdf", array("rel"=>"external")); ?> for keywords that you can text to get more information about your holds and the text notice services. 
					</fieldset>
...
<div id="submit_form" class="hidden">				
