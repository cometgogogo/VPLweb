...
<?php
	...
	$relatedContentElements[] = array ('image', array("image"=> array("source"=>"/img/cela.jpg","width"=>"200", "height"=>"200", "title"=>"CELA", "link"=>"http://www.celalibrary.ca/iguana/www.main.cls?surl=defaultCELA&language=eng", "target"=>"_blank")));
...
<div style="display: none !important;"><h2>Library Service</h2></div>
	...
	<h3>Notebooks</h3>
	<p>Notebooks are available for up to 2 hours loan, for in-library use. <br/><br/> Available at <?php echo $this->Html->link("all VPL locations","/libraries"); ?> except <?php echo $this->Html->link("Kleinburg Library","/libraries/view/5"); ?>.</p>
		...
		<p>Sign out library materials by yourself with your library card. Follow the step-by-step instructions on the screen to check out or renew your materials. When you are finished, you can choose to take the receipt which includes the due-dates.  <br/><br/><em>Not available at <?php echo $this->Html->link("Kleinburg Library","/libraries/view/5"); ?>.</em>
		</p>

       		 <h3>Printing, Photocopy and Scanning</h3>
		
				<p>
				Printing and photocopy are available at <?php echo $this->Html->link("all VPL locations","/libraries"); ?>. Using VPL's <a href="https://webprint.vaughanpl.info">WebPrint site</a>, customers can now send a print job from their laptop, Android devices and even home computer, and pick it up at any branch except Kleinburg Library.</p>
				
				<ul><li>Black & White - $0.10 (letter/legal)</li><li>Colour<sup>*</sup> - $0.40 (letter/legal)</li><li>Scan<sup>*</sup>  - $0.05</li></ul>
<p>
			<em><sup>*</sup>&nbsp; Scanning, colour printing and colour photocopy are not available at <?php echo $this->Html->link("Kleinburg Library","/libraries/view/5"); ?>.</em>
	...
	<div id="room" class="tab"><br/>
		...
		<div id="meetingroom" class="entry" style="display: none">
			...
			<img src="/img/icon-pdf.gif" alt="PDF" /><?php echo $this->Html->link("Applicable Charges","/files/services/List_of_Charges.pdf"); ?><br/><br/>
			<img src="/img/icon-pdf.gif" alt="PDF" /><?php echo $this->Html->link("Application for use of meeting room","/files/services/meeting_room.pdf"); ?><br/><br/>
			<img src="/img/icon-pdf.gif" alt="PDF" /><?php echo $this->Html->link("Meeting room capacities","/files/services/meeting_cap.pdf"); ?><br/><br/>
			<img src="/img/icon-pdf.gif" alt="PDF" /><?php echo $this->Html->link("Application for CSO status", "https://www.vaughan.ca/services/recreation/General%20Documents/Facility%20Rentals/CSO%20Policy%20Brochure_12014.pdf");?><br/><br/>
		<img src="/img/icon-pdf.gif" alt="PDF" /><?php echo $this->Html->link("Operational Policy","/files/services/OperationalPolicy.pdf"); ?>
		...
		<div class="section_end">&nbsp;</div>
			...
			<ul>
				...
				<p>
				VPL believes in providing access to cultural opportunities in the community by making exhibit space available to artists and community groups. Interested groups are encouraged to submit a completed <?php echo $this->Html->link("Application for Exhibit Space","/files/exhibit_space.pdf"); ?> form to their preferred library location.
				</p>
		...
		<div class="entry">
			<h3>Proctoring Examination Invigilation Guidelines</h3>
				...
				<ol>
								...
								<li>The student must complete an <?php echo $this->Html->link("application form","/proctor")?> and submit it to the library for approval.  A librarian will proctor an exam only if the application has been approved. </li>
				...
				<p>If you would like to know more about this service, please contact your <?php echo $this->Html->link("local branch","/libraries")?> at 905-653-READ (7323).</p>
...
<div id="homebound" class="tab">
	...
	<div id="cela" class="tab">
			<h3>Centre for Equitable Library Access Collection</h3>
			<div class="entry">
<p>Vaughan Public Libraries offers a collection of over 230,000 books, magazines, newspapers and described videos in a choice of formats for people with a print disability.</p>
			 <ul>
						<li>Lots of choice including current bestsellers, award-winners and classics</li>
						<li>Fiction, non-fiction, self-help, business and more</li>
						<li>Books for kids, teens and adults</li>
						<li>Books in audio, braille or accessible e-book formats</li>
						<li>Download books or receive home delivery by mail</li>

		   </ul>
	</div>
	<h3>Eligibility</h3>
				<div class="entry">
	<p>Access to the CELA collection is available to people who are unable to read conventional print due to a disability, which includes:</p>
				 <ul>
<li>Learning disability: an impairment relating to comprehension</li>
<li>Physical disability: the inability to hold or manipulate a book</li>
<li>Visual disability: severe or total impairment of sight or the inability to focus or move one's eyes</li>

	
			   </ul>
	</div>
	
<h3>How to sign up for CELA</h3>
			<div class="entry">
...
<p>Library customers who have a valid library card may also register themselves for CELA service at <a href="http://signup.celalibrary.ca" target="_blank">signup.celalibrary.ca</a>. </p>

<p>Customers need not provide proof of disability when registering for CELA Services.</p>
<p>After customers complete the self-registration process, they will receive a link which has full details of how CELA works and how to access assistance. </p>
	</div>
	<h3>Access to the collection is offered in a number of ways</h3>
				<div class="entry">

				 <ul>
<li>Download books to your computer or mobile device, such as an iPhone</li>
<li>Download books to a DAISY player over a wireless connection without using a computer</li>
<li>Receive audio CDs, Braille or described movies through your local branch or by mail directly to your home.</li>	
			   </ul>
			   <p>The CELA website can be found at: <a href="http://www.celalibrary.ca" target="_blank">www.celalibrary.ca</a></p>
	</div>	
	
<h3>Accessible Summer Reading Club</h3>
			<div class="entry">
<p>No matter how you read or how you play TD Summer Reading Club is accessible for everyone!  This summer SRC materials will be accessible through a collection of daisy discs relating to this year's Summer Reading Club theme available at all eight branches of Vaughan Public Libraries.</p>


<p>Library customers who have a valid library card may also register themselves for CELA service at <a href="http://signup.celalibrary.ca" target="_blank">signup.celalibrary.ca</a>. </p>

<p>Each Vaughan Public Library will receive a mini deposit of "Play" themed DAISY discs from CELA in English and French. These are in addition to previous years' <a href="https://catalogue.vaughanpl.info/catalogue/search/query?term_1=DAISY+disc&theme=vaughan" target="_blank">DAISY discs</a> and the wide range of <a href="https://catalogue.vaughanpl.info/catalogue/search/query?match_1=MUST&field_1&term_1=audio+books&facet_format=sound_recording.audiobook&facet_ta=j&sort=relevance&theme=vaughan" target="_blank">junior audio-books</a> available all year round. </p>
	</div>
	<h3>Parents and Educators</h3>
				<div class="entry">

			   <p>Does your child struggle with the written word? Do you want to help them get ahead?</p><p>VPL and CELA have teamed up to make reading accessible for everyone. If your child has a learning, sight or physical disability that makes reading a conventional book difficult please read on.</p><p>CELA offers a service that connects you with audio materials that make the stories and reading experience fulfilling for your child.  CELA has a large library of books on MP3. In addition CELA uses DAISY disc technology that makes browsing an audio book with a DAISY player easy.</p><p>Your Library card gives you free access to CELA's services. One of our librarians will be happy to take you through the set up process at the Service Desk. If you want to use the internet to borrow books it takes just a few minutes in person or on the phone to register. CELA can also deliver discs to your door. The set up with a VPL librarian takes a little longer but the service is great! We can even recommend books your children might want to listen to!</p><p>Did you know VPL also has a large selection of audio books for children from early child hood into the teen years and beyond in every branch? Visit us to see what we have to offer in addition to your CELA audiobooks.</p>
	</div>	
