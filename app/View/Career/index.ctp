...
<?php
$relatedContentElements = array	(array ('related_pages', array("pages"=>array(array("Title"=>"Library Services","url"=>"/library_services"), array("Title"=>"Email Librarian","url"=>"/email_librarian"), array("Title"=>"Employment Opportunities","url"=>"/jobs"), array("Title"=>"Volunteer Opportunites","url"=>"/volunteers")))));
...
<!----- Collection Starts ----->
	...
	<h3>Topics</h3>
			...
			<ul>
					<li><div class="name"><a rel="external" href="http://catalogue.vaughanpl.info/catalogue/search/query?match_1=SHOULD&field_1=s&term_1=resumes+%22cover+letters%22&sort=sort_ss_date%3Bdescending,sort_ss_author">Resumes & Cover Letters</a></div></li>
					<li><div class="name"><a rel="external" href="http://catalogue.vaughanpl.info/catalogue/search/query?match_1=PHRASE&field_1=s&term_1=Employment+interviewing.&sort=sort_ss_date%3Bdescending,sort_ss_author">Interviews</a></div></li>
					<li><div class="name"><a rel="external" href="http://catalogue.vaughanpl.info/catalogue/search/query?match_1=MUST&field_1=s&term_1=Job+Hunting&sort=sort_ss_date%3Bdescending,sort_ss_author">Job Hunting</a></div></li>
					<li><div class="name"><a rel="external" href="http://catalogue.vaughanpl.info/catalogue/search/query?match_1=SHOULD&field_1=s&term_1=%22career+changes%22+%22vocational+guidance%22&sort=sort_ss_date%3Bdescending,sort_ss_author">Career Changes & Vocational Guidance</a></div></li>
