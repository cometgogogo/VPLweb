...
class HabtmHelper extends HtmlHelper {
     ...
     *<?php echo $habtm->checkboxMultiple('BusinessWorkshop/time_slot', $time_slot, @$this->data["business_workshop"]["time_slot"], array('multiple' => 'multiple', 'id'=>'time_slot'), null, false); ?>
     *
     */
...
$label="<label for='" . $optionsHere['id'] . "'>" . $title. "</label>";
            $checkbox[] .= "<div class=\"name\">" . sprintf($this->tags['checkboxmultiple'], $this->model, $this->field, $this->parseHtmlOptions($optionsHere), $label) . "</div>\n";
            /**
