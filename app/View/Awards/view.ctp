...
<?php $this->Html->addCrumb("Award Winners" , "/awards");
...
<div id="page_content">
	...
	<div class="details">
		...
		<h2>Official website</h2>
				...
				<br />
				<?php echo $this->Html->link("Visit site", $award['Award']['website'], array("rel"=>"external")); ?>
		</p>
		<?php } ?>
...
<div class="book_list">
					...
					<form method="get" action="http://catalogue.vaughanpl.info/catalogue/search/query">
						<input type="hidden" name="term_1" value="<?php echo $winner['author']; ?>" />
						<input type="hidden" name="field_1" value="a" />
						<?php if(!empty($winner['title'])) { ?>
							<input type="hidden" name="term_2" value="<?php echo str_replace(':', ' ',$winner['title']); ?>" />
