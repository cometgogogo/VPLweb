...
$eventID = $dateTimeArray[$i]['EventID'];
		...
		?>
				...
				<input type='radio' name='regDate' value='<?php echo $dates[$i]; ?>'> <?php echo $dates[$i]; ?><?php echo "&nbsp;&nbsp;&nbsp;&nbsp;<i>(". $dateTimeArray[$i]['NumOfSpace'] . " spots available)</i>"; ?><br/>
		<?php
				}
			}
...
?>
				...
				<input type='radio' name='regDate' value='<?php echo $dateTimeArray[$i]["StartDate"]; ?>'><?php echo $dateTimeArray[$i]["StartDate"]; ?><?php echo "&nbsp;&nbsp;&nbsp;&nbsp;<i>(". $dateTimeArray[$i]['NumOfSpace'] . " spots available)</i>"; ?><br/>
		<?php
			//echo "<option value=\"" . $dateTimeArray[$i]['StartDate']. "\">". $dateTimeArray[$i]['StartDate'] . "</option>";
		}
